...
**Reference Resources:**
- Reuse any existing Remotion composition/template files already present in the host project when available
- Otherwise, create a minimal `ScreenSlide` component and validate it against the composition requirements listed in this skill
- Review official Remotion examples or project-local examples before polishing transitions and timing
